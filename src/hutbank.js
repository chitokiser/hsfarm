      ...
      const contractAddress = {
        ...
        cyabankAddr:"0xc490E20CFdF817B5412D58864226e01560dA37a8" //hutbank
   }
  ...
  let Buymut = async () => {
    ...
    try {
      await cyabankContract.buyhut(document.getElementById('buyAmount').value);
    } catch(e) {
      alert(e.data.message.replace('execution reverted: ',''))
    }
  };
  ...
  let Sellmut = async () => {
    ...
    try {
      await cyabankContract.sellhut(document.getElementById('sellAmount').value);
    } catch(e) {
      alert(e.data.message.replace('execution reverted: ',''))
    }
  };
